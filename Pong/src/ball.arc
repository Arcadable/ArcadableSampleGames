...
stepBall: Function {
    ...
    if(ballH > 0) {
        ...
        if(ballX >= screenWidthMin1) {
            if(player2Lives == 0) {
                ...
                tone(player2Speaker, 1, 150, 100);
            } else {
                if(ballX >= screenWidth) {
                    player2Lives = player2Lives - 1;
                    execute(scored);
                    if(inMenu < 2) {
                        tone(player2Speaker, 1, 80, 400);
                    }
                }
            }
        }
    ...
    if (ballH < 0) {
        ...
        if(ballX <= 1) {
            if(player4Lives == 0) {
                ballH = ballHPositive;
                tone(player4Speaker, 1, 150, 100);
            } else {
                if(ballX <= 0) {
                    player4Lives = player4Lives - 1;
                    execute(scored);
                    if(inMenu < 2) {
                        tone(player4Speaker, 1, 80, 400);
                    }
                }
            }
        }
    ...
    if (ballV > 0) {
        ...
        if (ballY >= screenHeightMin1) {
            if (player3Lives == 0) {
                ballV = ballVNegative;
                tone(player3Speaker, 1, 150, 100);
            } else {
                if(ballY >= screenHeight) {
                    player3Lives = player3Lives - 1;
                    execute(scored);
                    if(inMenu < 2) {
                        tone(player3Speaker, 1, 80, 400);
                    }
                }
            }
        }
    ...
    if (ballV < 0) {
        ...
        if (ballY <= 1) {
            if (player1Lives == 0) {
                ballV = ballVPositive;
                tone(player1Speaker, 1, 150, 100);
            } else {
                if(ballY <= 0) {
                    player1Lives = player1Lives - 1;
                    execute(scored);
                    if(inMenu < 2) {
                        tone(player1Speaker, 1, 80, 400);
                    }
                }
            }
        }
