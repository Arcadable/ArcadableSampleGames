...
player1ContinueButton: Digital = 8;
player2ContinueButton: Digital = 15;
player3ContinueButton: Digital = 4;
player4ContinueButton: Digital = 3;
...
playerWon: Function {
    ...
    execute(resetGame);
    execute(playerWinSound);
}

playerWinSound: AsyncFunction {
    tone(player1Speaker, 0.5, 100, 100);
    tone(player2Speaker, 0.5, 100, 100);
    tone(player3Speaker, 0.5, 100, 100);
    tone(player4Speaker, 0.5, 100, 100);
    wait(100);

    tone(player1Speaker, 0.5, 200, 100);
    tone(player2Speaker, 0.5, 200, 100);
    tone(player3Speaker, 0.5, 200, 100);
    tone(player4Speaker, 0.5, 200, 100);
    wait(100);

    tone(player1Speaker, 0.5, 400, 300);
    tone(player2Speaker, 0.5, 400, 300);
    tone(player3Speaker, 0.5, 400, 300);
    tone(player4Speaker, 0.5, 400, 300);
    wait(300);
}